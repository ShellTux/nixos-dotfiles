	...
	config = lib.mkIf config.ncmpcpp.enable {
		programs.ncmpcpp = {
			...
			package = pkgs.ncmpcpp.override {
				visualizerSupport = config.ncmpcpp.visualizerSupport;
				clockSupport = config.ncmpcpp.clockSupport;
			};
			...
			settings = {
				...
				## Visualizer ##
				visualizer_data_source = lib.mkIf config.ncmpcpp.visualizerSupport "/tmp/mpd.fifo";
				visualizer_output_name = lib.mkIf config.ncmpcpp.visualizerSupport "my_fifo";
				visualizer_type = lib.mkIf config.ncmpcpp.visualizerSupport "spectrum";
				visualizer_in_stereo = lib.mkIf config.ncmpcpp.visualizerSupport "yes";
				visualizer_look = lib.mkIf config.ncmpcpp.visualizerSupport "◆▋";
