...
let
  ...
  command = {
    shell = {
      silent =
        command:
        "<enter-command>unset wait_key<enter><shell-escape>${command}<enter><enter-command>set wait_key<enter>";
      wait =
        command:
        "<enter-command>set wait_key<enter><shell-escape>${command}<enter><enter-command>unset wait_key<enter>";
