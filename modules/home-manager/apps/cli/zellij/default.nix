{ lib, config, ... }:
{
  ...
  config = lib.mkIf config.apps.cli.zellij.enable {
    programs.zellij = {
      enable = true;

      enableBashIntegration = config.apps.cli.zellij.enableBashIntegration;
      enableZshIntegration = config.apps.cli.zellij.enableZshIntegration;
